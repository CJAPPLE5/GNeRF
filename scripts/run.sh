...
=======
    $TEST_PREFIX python testing/test_ibrnet.py ${DATA_BASE}/${TEST_SCENE} \
    --workspace ./log/spaseview/${EXP_NAME}/${DATASET}/${TEST_SCENE}/view_${TRAIN_NUM}_ibr/${NETWORK} \
>>>>>>> 7684a7c5778e12216dd39901712914f12297267a
